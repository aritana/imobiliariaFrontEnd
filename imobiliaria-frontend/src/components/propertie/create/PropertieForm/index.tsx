...
const PropertieForm = (props: { history: string[], address: CreateAddressInterface }) => {
    ...
    const [condominiumValue, setCondominiumValue] = useState<number | undefined>(undefined)
    const [fullConcierge, setFullConcierge] = useState<boolean | undefined>(undefined)
        ...
        <div className='form-content'>
            ...
            <form onSubmit={async (e) => await handleSubmit(e)}>
                <input
                    ...
                    min={1}
                    required={true}
                    onChange={(event: React.ChangeEvent<HTMLInputElement>) => setRoomsAmount(Number(event.target.value))}
                >
                </input>
                <input
                    ...
                    min={0}
                    required={true}
                    onChange={(event: React.ChangeEvent<HTMLInputElement>) => setSuitesAmount(Number(event.target.value))}
                >
                </input>
                ...
                <input
                    ...
                    min={0}
                    required={true}
                    onChange={(event: React.ChangeEvent<HTMLInputElement>) => setLivingRoomsAmount(Number(event.target.value))}
                >
                </input>
                ...
                <input
                    ...
                    min={0}
                    required={true}
                    onChange={(event: React.ChangeEvent<HTMLInputElement>) => setDiningRoomsAmount(Number(event.target.value))}
                >
                </input>
                ...
                <input
                    ...
                    min={0}
                    required={true}
                    onChange={(event: React.ChangeEvent<HTMLInputElement>) => setParkingAmount(Number(event.target.value))}
                >
                </input>
                ...
                <input
                    ...
                    min={0}
                    required={true}
                    onChange={(event: React.ChangeEvent<HTMLInputElement>) => setBuiltInCabinetsAmount(Number(event.target.value))}
                >
                </input>
                ...
                <input
                    ...
                    min={0}
                    required={true}
                    onChange={(event: React.ChangeEvent<HTMLInputElement>) => setRentValue(Number(event.target.value))}
                >
                </input>
...

                {
                    ...
                    <div>
                        <input
                            ...
                            min={1}
                            required={true}
                            onChange={(event: React.ChangeEvent<HTMLInputElement>) => setFloor(Number(event.target.value))}
                        >
                        </input>
                        ...
                        <input
                            ...
                            min={0}
                            required={true}
                            onChange={(event: React.ChangeEvent<HTMLInputElement>) => setCondominiumValue(Number(event.target.value))}
                        >
                        </input>
                            ...
                            <FormControlLabel className='checkBox-item'
                                control={
                                    <BlueCheckbox
                                        ...
                                        onChange={(event: React.ChangeEvent<HTMLInputElement>) => setFullConcierge(!(fullConcierge || false))}
                                        name='fullConcierge'
                                    />
                                }
